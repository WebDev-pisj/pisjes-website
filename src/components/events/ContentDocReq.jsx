...
<br/>
Copies of: (Each Copy on Separate Page) <br/> </p>
                  <p className="td_mb_30 td_fs_18">
                  ...
                  <div className="td_mb_40">
                    <ul className="td_list td_style_2 td_type_2 td_fs_18 td_medium td_heading_color td_mp_0">
                      ...
                      <li>
                        ...
                        Student’s visa page (if Iqama under process)
                      </li>
                      <li>
                        <svg
                          className="td_accent_color"
                        ...
                        Parent’s (Father & Mother) valid Iqama and passport
                      </li>
                      <li>
                        <svg
                          className="td_accent_color"
                      ...
                      <li>
                       ...
                       Student’s vaccination/immunization certificate
                      </li>
                      <li>
                        <svg
                          className="td_accent_color"
                      ...
                      <li>
                       ...
                       Student’s report cards for all academic years (Not Applicable for Kindergarten).
                      </li>
                    </ul>
                  </div>
