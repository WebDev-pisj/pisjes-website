          ...
          >
            <div className="td_cta_in">
              ...
              <p className="td_mb_30 td_white_color td_opacity_7 td_fs_18">
                Please Click below button to view/download Academic Calendar 2025-2026.
Keep Visiting the website for further updates.
              </p>
              <Link
                href="/home_1/Academic-Calendar-2025-2026.v10.pdf"
